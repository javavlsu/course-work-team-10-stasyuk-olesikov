...
public interface GameVersionRepository extends JpaRepository<GameVersion, Integer>
{
     ...
     * @throws org.springframework.dao.DataAccessException при ошибке доступа к базе данных
     */
     ...
     *
     * @throws IllegalArgumentException если commitHash равен null или пустая строка
     * @throws org.springframework.dao.DataAccessException при ошибке доступа к базе данных
     */
